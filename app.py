...
app.config["DATABASE"] = os.path.join(BASE_DIR, "greenbin.db")
...
def collector_dashboard():
    ...
    for trip in route_plan.trips:
        if trip.complete:
            trip.color_class = "trip-chip-success"
        elif trip.over_capacity:
            trip.color_class = "trip-chip-danger"
        elif trip.active_trip:
            trip.color_class = "trip-chip-info"
        else:
            trip.color_class = "trip-chip-info"
